# @hishprorg/corrupti-accusantium

[![Build Status](https://secure.travis-ci.org/nathanboktae/@hishprorg/corrupti-accusantium.png)](http://travis-ci.org/nathanboktae/@hishprorg/corrupti-accusantium)

@hishprorg/corrupti-accusantium is an extension to the [chai](http://chaijs.com/) assertion library that
...
```
npm install @hishprorg/corrupti-accusantium
```

### bower

```
bower install @hishprorg/corrupti-accusantium
```
...
chai.use(require('@hishprorg/corrupti-accusantium'))
```

### AMD

```javascript
require(['chai', '@hishprorg/corrupti-accusantium'], function(chai, chaiDom) {
  chai.use(chaiDom)
})
```
...
<script src="@hishprorg/corrupti-accusantium.js"></script>
```
